class Planets::RoguePlanetsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @planets_rogue_planet.update(planets_rogue_planet_params)
        ...
        format.json { render :show, status: :ok, location: @planets_rogue_planet }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to planets_rogue_planets_url, notice: 'Rogue planet was successfully destroyed.' }
