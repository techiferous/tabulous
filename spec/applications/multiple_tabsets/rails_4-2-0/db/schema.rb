...
ActiveRecord::Schema.define(version: 20141222134936) do
  ...
  create_table "planets_exoplanets", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "planets_rogue_planets", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
