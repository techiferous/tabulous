class Galaxies::SpiralGalaxiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @galaxies_spiral_galaxy.save
        ...
        format.json { render :show, status: :created, location: @galaxies_spiral_galaxy }
      else
  ...
  def update
    respond_to do |format|
      if @galaxies_spiral_galaxy.update(galaxies_spiral_galaxy_params)
        ...
        format.json { render :show, status: :ok, location: @galaxies_spiral_galaxy }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to galaxies_spiral_galaxies_url, notice: 'Spiral galaxy was successfully destroyed.' }
