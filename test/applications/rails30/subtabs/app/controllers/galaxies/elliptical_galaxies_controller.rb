    ...
    def create
      ...
      respond_to do |format|
        if @elliptical_galaxy.save
          format.html { redirect_to(galaxies_elliptical_galaxy_path(@elliptical_galaxy), :notice => 'Elliptical galaxy was successfully created.') }
    ...
    def update
      ...
      respond_to do |format|
        if @elliptical_galaxy.update_attributes(params[:elliptical_galaxy])
          format.html { redirect_to(galaxies_elliptical_galaxy_path(@elliptical_galaxy), :notice => 'Elliptical galaxy was successfully updated.') }
          format.xml  { head :ok }
        else
