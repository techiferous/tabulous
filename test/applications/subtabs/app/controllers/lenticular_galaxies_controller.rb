class LenticularGalaxiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @lenticular_galaxy.save
        format.html { redirect_to(@lenticular_galaxy, :notice => 'Lenticular galaxy was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @lenticular_galaxy.update_attributes(params[:lenticular_galaxy])
        format.html { redirect_to(@lenticular_galaxy, :notice => 'Lenticular galaxy was successfully updated.') }
        format.xml  { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(lenticular_galaxies_url) }
      format.xml  { head :ok }
    end
  end
end
